...
//The following are private tags for Deep Wise
#define DW_PRIVATE_TAG_GROUP                        0x7001       /* group tag, if it's odd, it's a private tag   */
#define DW_PRIVATE_CREATOR_TAG                      0x7001, 0x0010
#define DW_TAG_AI_RESULT_NUM                        0x7001, 0x0020       /* group tag, if it's odd, it's a private tag   */
#define DW_TAG_AI_RESULT                           "7001|0020" /* Json data from DW AI   */
#define DW_TAG_AI_RESULT_Element                    0x0020       /* element tag, if it's odd, it's a private tag   */
#define DW_TAG_OLD_SERIES_NUM                       0x7001, 0x0030 /* Json data from DW AI   */
#define DW_TAG_OLD_SERIES                          "7001|0030" /* Json data from DW AI   */
#define DW_TAG_OLD_SERIES_ELEMENT                   0x0030       /* group tag, if it's odd, it's a private tag   */

inline bool IsTagValid(unsigned short gTag)
{
    if (gTag == DW_PRIVATE_TAG_GROUP)
    {
        return true;
    }
