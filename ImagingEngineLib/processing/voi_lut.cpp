...
#define RGBA_TO_LONG(r,g,b,a) ((unsigned long)(((unsigned char)(r)|((unsigned long)((unsigned char)(g))<<8))|(((unsigned long)(unsigned char)(b))<<16)|(((unsigned long)(unsigned char)(a))<<24)))
...
{
	lut_table_ = new unsigned long [kMaxCTV];
...
unsigned long *VoiLut::GetLutTable() const
{
	return lut_table_;
}
